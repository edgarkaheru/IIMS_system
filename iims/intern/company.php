...
if (isset($_POST['submit'])){
    ...
    $query = mysqli_query($con, "INSERT INTO company(interneename,companyname,companyaddress,companylocation)VALUES('$interneename','$companyname','$companyaddress','$companylocation')");
}
?>
    <!DOCTYPE html>
<html lang="en">
	            ...
	            <div class="col-lg-6 col-md-6 offset-lg-3 offset-md-3">
	            	...
	            	<div class="card-body">
                                        ...
                                        <div class="row pt-3">
	            	                            ...
	            	                            <div class="col">
                                                <label for="">internee name</label>
	                                            <input type="text" class="form-control" placeholder="Enter internee name" name="interneename" >
                                              </div>
	            	                        </div>
                                            <div class="row pt-3">
                                              <div class="col">
	                                              <label for="">Company Address</label>
	                                              <input type="text" class="form-control" placeholder="Enter  companyaddress" name="companyname" >
                                              </div>
                                          </div> 
	            	                      <div class="row pt-3">
                                              <div class="col">
            ...
            <div class="col">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th style="color:black;font-size:22px;text-align:center">intern name</th>
                                <th style="color:black;font-size:22px;text-align:center">company name</th>
                                <th style="color:black;font-size:22px;text-align:center">company address</th>
                                <th style="color:black;font-size:22px;text-align:center">company location</th>
                            </tr>
                        </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td style="color:white;font-size:18px;"><?php echo htmlentities($row['interneename']); ?></td>
