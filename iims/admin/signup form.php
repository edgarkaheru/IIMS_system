...
if(isset($_POST['signup'])){
    ...
    $query = mysqli_query($con, "INSERT INTO admin(surname,lastname,contact,email,username,password) VALUES('$surname','$lastname','$contact','$email','$username','$password')");
            ...
            <div class="col-lg-6 col-md-6 offset-lg-3 offset-lg-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row pt-4">
                	    <div class="col">
                      <p>Already have  an Account?<a href="index.php">Login Here <b></b></a></p>
                  </div>
              </div>
                    </div>
                </div>
